...
#noisy layer as in paper NoiseNet
...
class ActorCritic(nn.Module):
    def __init__(self, state_dim, action_dim, n_latent_var, action_std):
        ...
        self.action_layer = nn.Sequential(
            NoisyLinear(state_dim,n_latent_var),
            ...
            NoisyLinear(n_latent_var, n_latent_var),
            # nn.Linear(n_latent_var, n_latent_var),

            # nn.LayerNorm(n_latent_var),
            nn.Tanh(),
            NoisyLinear(n_latent_var, action_dim),
...
rewards = train(add_parameter_noise=False, max_episodes=50000,pretrained=False)
